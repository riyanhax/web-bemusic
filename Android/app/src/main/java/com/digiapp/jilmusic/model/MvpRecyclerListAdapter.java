...
public abstract class MvpRecyclerListAdapter<M, P extends BasePresenter, VH extends MvpViewHolder<P>> extends MvpRecyclerAdapter<M, P, VH> {
    ...
    public MusicTrackViewHolder.ItemClickListener itemClickListener;
    public void setItemClickListener(MusicTrackViewHolder.ItemClickListener itemClickListener) {
    ...
    public void removeAllAddAll(Collection<M> data) {
        models.clear();
