...
import com.digiapp.jilmusic.model.MusicProviderSource;
    ...
    public void play(QueueItem item) {
        ...
        if (mediaHasChanged || mExoPlayer == null) {
           ...
           /* MediaMetadataCompat track =
            ...
            MusicTrack musicTrack = mMusicProvider.getMusic(MediaIDHelper.extractMusicIDFromMediaID(item.getDescription().getMediaId()));
            if(musicTrack==null){
                return;
            }
            MediaMetadataCompat track = musicTrack.item;
