            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                    ...
                    if (StringUtils.isNotEmpty(assetName)) {
                        ...
                        if (StringUtils.isNotEmpty(mimeType)) {
                            try {
                                ...
                                return WebviewResourceHelper.getWebResourceResponseFromAsset(assetName, mimeType, encoding);
                            } catch (IOException e) {
                                e.printStackTrace();
                                return super.shouldInterceptRequest(view, request);
                            }
                    ...
                    if (StringUtils.isNotEmpty(localFilePath)) {
                        ...
                        if (StringUtils.isNotEmpty(mimeType)) {
                            try {
                                ...
                                return WebviewResourceHelper.getWebResourceResponseFromFile(localFilePath, mimeType, encoding);
                ...
                if (fileExtension.endsWith("jpg")
                    ...
                    try {
                        ...
                        if (inputStream != null) {
                            return new WebResourceResponse(WebviewResourceHelper.getMimeType(fileExtension.replaceAll(".", "")), "UTF-8", inputStream);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                        return super.shouldInterceptRequest(view, request);
                    ...
                    InputStream inputStream = DiskCacheHelper.readFromCacheSync(resourceUrl);
                    if (inputStream != null) {
                        return new WebResourceResponse(WebviewResourceHelper.getMimeType("https://www.youtube.com/"), "UTF-8", inputStream);
                    }
                }
                else if(resourceUrl.contains("/image/")){
                    InputStream inputStream = DiskCacheHelper.readFromCacheSync(resourceUrl);
                    if (inputStream != null) {
                        return new WebResourceResponse(WebviewResourceHelper.getMimeType("/image/"), "UTF-8", inputStream);
                    }
                }
                else{
