...
import com.digiapp.jilmusic.AlbumArtCache;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private PendingIntent createContentIntent(MediaDescriptionCompat description) {
        ...
        Intent openUI = new Intent(mService, DashboardActivity.class);
        openUI.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        openUI.putExtra(DashboardActivity.EXTRA_START_FULLSCREEN, true);
        if (description != null) {
            openUI.putExtra(DashboardActivity.EXTRA_CURRENT_MEDIA_DESCRIPTION, description);
        }
        return PendingIntent.getActivity(mService, REQUEST_CODE, openUI,
                PendingIntent.FLAG_CANCEL_CURRENT);
    }
    ...
    private Notification createNotification() {
        ...
        int mediaId = Integer.parseInt(description.getMediaId());
        MusicTrackDAO musicTrackDAO = MusicRoomDatabase.getDatabase(AppObj.getGlobalContext()).musicTrackDAO();
        MusicTrack musicTrack = musicTrackDAO.getById(mediaId);
        ...
        fetchArtUrl = musicTrack.localPicturePath;

        final NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(mService, CHANNEL_ID);

        Log.d("debug","notification_created MediaNotificationManager");

        // RemoteViews contentView = new RemoteViews(AppObj.getGlobalContext().getPackageName(), R.layout.notification_view_small);

        BitmapFactory.Options bmOptions = new BitmapFactory.Options();
        Bitmap image = BitmapFactory.decodeFile(musicTrack.localPicturePath,bmOptions);
        ...
        notificationBuilder
                ...
                .setColorized(true)
                .setColor(ContextCompat.getColor(AppObj.getGlobalContext(), R.color.color_back))
                .setSmallIcon(R.mipmap.ic_launcher)
                .setLargeIcon(image)
                .setVisibility(NotificationCompat.VISIBILITY_PUBLIC)
                .setOnlyAlertOnce(true)
                .setContentIntent(createContentIntent(description))
                .setContentTitle(musicTrack.name)
                .setContentText(musicTrack.album_name);
        ...
        // change our online player
        WebViewNotificationManager.mCurrentAction = "none";
