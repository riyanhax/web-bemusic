...
export class CurrentUser {
    ...
    /**
     * Check if user JiL subscription is active
     */
    public jilSubscriptionIsActive(): boolean {  
        if(this.current.subscription == null){
            return this.current.subscription_s;
        }else if(this.current.subscription_s){
            var date_expired = new Date(this.current.subscription.replace(/-/g,"/"));            
