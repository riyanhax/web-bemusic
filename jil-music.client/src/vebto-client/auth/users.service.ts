...
export class Users {
     ...
     */
    public get(id: number, params?: {with?: string}): Observable<{user: User}> {
    ...
    public subscribAdd(id: number, payload: Object): Observable<User> {
        return this.http.put('users/'+id+'/subscrib', payload);
    }
    ...
    /**
     * Change user ads limit.
     */
    public changeAdsLimit(id: number): Observable<User> {
        return this.http.post('users/'+id+'/adslimit');
    }
}
