...
import {TwilioSettingsComponent} from "./twilio/twilio-settings.component";
import {VideoadsSettingsComponent} from "./videoads/videoads-settings.component";
...
export const vebtoSettingsRoutes: Route[] = [
    ...
    {path: 'twilio', component: TwilioSettingsComponent},  
    {path: 'videoads', component: VideoadsSettingsComponent},    
