...
import {UserGenresResolver} from "./web-player/genres/user-genres/user-genres-resolver.service";
import {UserGenresComponent} from "./web-player/genres/user-genres/user-genres.component";
...
export class AppComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.customHomepage.select([
            ...
            {path: 'my-genres', component: UserGenresComponent, resolve: {genres: UserGenresResolver}, data: {name: 'my-genres'}},            
