...
export class ArtistAlbumsTableComponent implements OnInit, OnChanges {
    ...
    ngOnChanges(changes: SimpleChanges) {
        if(this.dataSource) this.updateAlbumsTableData();
      }
    ...
    public openNewAlbumModal() {
        ...
        this.modal.show(CrupdateAlbumModalComponent, {artist: this.artist})
    ...
    public openEditAlbumModal(album: Album) {
        ...
        this.modal.show(CrupdateAlbumModalComponent, {artist: this.artist, album})
