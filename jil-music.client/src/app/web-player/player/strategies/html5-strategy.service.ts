...
export class Html5Strategy implements PlaybackStrategy {
    ...
    public bootstrapStub(track){        
        ...
        let sp2 = document.querySelector('.html5-player');            
        let parentDiv = sp2.parentNode;
        parentDiv.insertBefore(this.imgBackgroundParent, sp2);       
        
        document.querySelector('.html5-player').classList.add('hide-video-enable');
    }

    public bootstrapStubDestroy(){
        
            document.querySelector('.html5-player').classList.remove('hide-video-enable');
    ...
    private bootstrap() {
        ...
        //     this.imgBackground = document.createElement('img');
        //     this.imgBackground.classList.add('album-img-stub');
        //     document.querySelector('.html5-player').appendChild(this.imgBackground);
        // }
