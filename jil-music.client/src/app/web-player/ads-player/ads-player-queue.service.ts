...
export class AdsPlayerQueue {
     ...
     * PlayerState Service.
     */
    constructor(private state: AdsPlayerState, private localStorage: LocalStorage) {}
    ...
    public set(index: number) {
        ...
        this.pointer = index;
        this.localStorage.set('ads_player.queue.pointer', index);
    }
}
