...
@Component({
    selector: 'ads-player-controls',
    templateUrl: './ads-player-controls.component.html',
    styleUrls: ['./ads-player-controls.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class AdsPlayerControlsComponent implements OnInit {
