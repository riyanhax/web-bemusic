...
import {HomeGuard} from "vebto-client/guards/home-guard.service";
...
import {SubscriptionResolve} from "vebto-client/subscription/subscription-resolve.service";
import {SubscriptionComponent} from "vebto-client/subscription/subscription.component";

import {UserGenresSettingResolve} from "vebto-client/user-genres/user-genres-resolve.service";
import {UserGenresSettingComponent} from "vebto-client/user-genres/user-genres.component";
...
const routes: Routes = [
    {path: '', component: WebPlayerComponent, canActivateChild: [CheckPermissionsGuard], data: {name: 'parent-home-route'}, children: [
        ...
        {path: '', component: UserGenresComponent, canActivate: [HomeGuard], resolve: {userStats: UserGenresResolver}, data: {name: 'home'}},
        ...
        {path: 'my-genres', component: UserGenresComponent, canActivate: [HomeGuard], resolve: {userStats: UserGenresResolver}, data: {name: 'user-stats'}},
        ...
        {path: 'subscription', redirectTo: 'account/subscription'},
        // {path: 'account/subscription', component:SubscriptionComponent, resolve: {resolves: SubscriptionResolve}, canActivate: [AuthGuard], data: {name: 'subscription'}},
        
        {path: 'my-genres-setting', redirectTo: 'account/my-genres-setting'},
        // {path: 'account/my-genres-setting', component:UserGenresSettingComponent, resolve: {resolves: UserGenresSettingResolve}, canActivate: [AuthGuard], data: {name: 'my-genres-setting'}},

        {path: 'account', component: UserAccountComponent, canActivate: [AuthGuard], canActivateChild: [AuthGuard], children: [
            {path: '', redirectTo: 'settings', pathMatch: 'full'},
            {path: 'settings', component: AccountSettingsComponent, resolve: {resolves: AccountSettingsResolve}, canActivate: [AuthGuard], data: {name: 'account-settings'}},
            {path: 'subscription', component:SubscriptionComponent, resolve: {resolves: SubscriptionResolve}, canActivate: [AuthGuard], data: {name: 'subscription'}},
            {path: 'my-genres-setting', component:UserGenresSettingComponent, resolve: {resolves: UserGenresSettingResolve}, canActivate: [AuthGuard], data: {name: 'my-genres-setting'}},            
        ]},
